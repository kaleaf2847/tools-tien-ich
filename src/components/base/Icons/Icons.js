...
export const SearchIcon = ({ width = 24, height = 24, className, ...props }) => {
  return (
    <svg
...
export const ChevronUpDownIcon = ({ width = 24, height = 24, className, ...props }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
ChevronUpDownIcon.propTypes = {
  width: PropTypes.number,
  height: PropTypes.number,
  class: PropTypes.string,
};

export const CreditCardIcon = ({ width = 24, height = 24, className, ...props }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const XIcon = ({ width = 24, height = 24, strokeWidth = 1.5, className, ...props }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const FacebookIcon = ({ width = 24, height = 24, className, ...props }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={width}
...
export const MailIcon = ({ width = 24, height = 24, className, ...props }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const MoonIcon = ({ width = 24, height = 24, className, type, ...props }) => {
  return type == 'solid' ? (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export const SunIcon = ({ width = 24, height = 24, className, type, ...props }) => {
  return type == 'solid' ? (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export const UserIcon = ({ width = 24, height = 24, className, ...props }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const SettingIcon = ({ width = 24, height = 24, className, ...props }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
